...
#     # --- Property/Farmer (Complex) ---
#     SEVEN_TWELVE_EXTRACT = "7_12_extract" # Satbara
#     MANDI_RECEIPT = "mandi_receipt"
...
#         ..., 
#         description="True if it looks like a scan/photo of a physical paper. False if it looks like a digital screenshot or edited."
#     )
#     visible_entities: List[str] = Field(
#         ..., 
#         description="List 3-4 key visible text headers (e.g., 'Income Tax Department', 'Form 16', '7/12')."
#     )
#     rejection_reason: Optional[str] = Field(
#         None, 
#         description="If rejected (unreadable or wrong type), explain why briefly to the user."
#     )
